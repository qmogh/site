      ...
      <Box
        sx={{
          ...
          backgroundImage: theme =>
            `linear-gradient(${theme.colors.red} 0%, ${theme.colors.red} 16.6666%, ${theme.colors.orange} 16.6666%, ${theme.colors.orange} 33.333%, ${theme.colors.yellow} 33.333%, ${theme.colors.yellow} 50%, ${theme.colors.green} 50%, ${theme.colors.green} 66.6666%, ${theme.colors.blue} 66.6666%, ${theme.colors.blue} 83.3333%, #8067C3 83.3333%, #8067C3 100%)`
        }}
      />
      <Flex
        as="header"
